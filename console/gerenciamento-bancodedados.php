...
if (!PHBPermissoes::Check("gerenciamento_bancodedados")) {
	header("Location: /index");
	die();
}
?>
...
<head>
	...
	<title><?= $config['NomeHotel']; ?> - <?= $lingua['gerenciamento-bancodedados-titulo']; ?></title>
...
<body class="main-body leftmenu <?= $config['TemaHK']; ?>-theme">
					...
					<div class="row ">
						<div class="col-lg-12 mt-xl-4">
							<div class="card custom-card overflow-hidden">
								<div class="card-body">
									<div>
										<h6 class="main-content-label mb-1"><?= $lingua['gerenciamento-bancodedados-texto1']; ?></h6>
										<p class="text-muted card-sub-title"><?= $lingua['gerenciamento-bancodedados-texto2']; ?></p>
									</div>
									<div id="divPhpMyAdmin"></div>
								</div>
							</div>
						</div>
					</div>
	...
	<script>
		$(document).ready(function() {
			document.getElementById("divPhpMyAdmin").innerHTML = "<iframe id=\"iframe\" src=\"/assets/phpMyAdmin-5.1.0-all-languages/index.php\">";
		});
	</script>
</body>
