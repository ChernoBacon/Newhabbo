 $(function(){
	...
	fetch("/system/api/phbplugin_peak_json.php")
    .then(function(response){
        return response.json();
    })
    .then(function(data){
		var jsonfile = data;
		var labels = jsonfile.phbplugin_peak.map(function(e) {
	var date = new Date(e.timestamp * 1000);
   return date;
});
var onlines = jsonfile.phbplugin_peak.map(function(e) {
   return e.onlines;
});;
var quartos = jsonfile.phbplugin_peak.map(function(e) {
   return e.quartos;
});;
