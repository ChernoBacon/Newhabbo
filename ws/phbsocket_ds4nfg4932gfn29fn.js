try {
    ...
    */
    ...
    function EventAlertCommand(data) {
        ...
        ImageAvatar.style.marginLeft = "-22px";
        ...
        Hotel21.id = "hotel21";
        Hotel21.innerText = "C'est le moment de démarrer une animation sur HabboZen.";
        ...
        Hotel22x.innerText = data.room_name;
    ...
    function OpenYoutubeVideoCommand(data) {
        ...
        IframeTag.src = `https://www.youtube.com/embed/${data.id}?autoplay=1`;
...
*/
    ...
    function MentionCommand(data) {
        ...
        new Audio("https://ws.newhabbo.fr/notif.mp3").play();
    ...
    function OpenYoutubeTvCommand(data) {
        ...
        for (var i = 0; i < playlist.length; i++) {
            ...
            divBox.onclick = function () {
                document.getElementById("youtube_frame").innerHTML = "<iframe class=\"youtube\" width=\"431\" height=\"302\" src=\"https://www.youtube.com/embed/" + video.video_id + "?autoplay=1\" allow=\"autoplay\"></iframe>";
            };
    ...
    function OpenYoutubeMusic(data) {
        ...
        IframeTag.frameborder = 0;
        IframeTag.src = `https://www.youtube.com/embed/${data.video_id}?autoplay=1`;
        IframeTag.allow = "autoplay";
        VideoContainer.appendChild(IframeTag);
        document.getElementById("PHBPlugin-YoutubePlayer").appendChild(VideoContainer);
        $("#PHBYTContainer").draggable({ containment: "window" });
    ...
    function OpenEditItemCommand(baseitem) {
        ...
        document.getElementById("PHBPlugin-editItem").innerHTML = "<div class=\"illumina-box ui-draggable ui-draggable-handle\" style=\"z-index: 999; left: 631px; top: 304px;\" id=\"editaritem\"><div class=\"illumina-box-title\">&nbsp;</div><div id=\"removeEditar\" onclick=\"RemoveEditItem()\" class=\"illumina-button-close\"></div>" +
            '<form name="editaritem" style="color: black" id="editaritem" onsubmit="return SaveItem()" method="post">' +
            "id: <input type='number' name='id' value='" + baseitem.id + "' disabled>" +
            "<br>sprite_id: <input type='number' name='sprite_id' value='" + baseitem.sprite_id + "'>" +
            "<br>public_name: <input name='public_name' value='" + baseitem.public_name + "'>" +
            "<br>item_name: <input name='item_name' value='" + baseitem.item_name + "'>" +
            "<br>type: <input name='type' value='" + baseitem.type + "'>" +
            "<br>item_width: <input type='number' name='item_width' value='" + baseitem.width + "'>" +
            "<br>item_length: <input type='number' name='item_length' value='" + baseitem.length + "'>" +
            "<br>stack_height: <input name='stack_height' value='" + baseitem.stack_height + "'>" +
            "<br>allow_stack: <select name='allow_stack'><option value='0'>0</option><option value='1' " + checkselected(baseitem.allow_stack) + ">1</option></select>" +
            "<br>allow_sit: <select name='allow_sit'><option value='0'>0</option><option value='1' " + checkselected(baseitem.allow_sit) + ">1</option></select>" +
            "<br>allow_lay: <select name='allow_lay'><option value='0'>0</option><option value='1' " + checkselected(baseitem.allow_lay) + ">1</option></select>" +
            "<br>allow_walk:  <select name='allow_walk'><option value='0'>0</option><option value='1' " + checkselected(baseitem.allow_walk) + ">1</option></select>" +
            "<br>allow_gift: <select name='allow_gift'><option value='0'>0</option><option value='1' " + checkselected(baseitem.allow_gift) + ">1</option></select>" +
            "<br>allow_trade: <select name='allow_trade'><option value='0'>0</option><option value='1' " + checkselected(baseitem.allow_trade) + ">1</option></select>" +
            "<br>allow_recycle: <select name='allow_recycle'><option value='0'>0</option><option value='1' " + checkselected(baseitem.allow_recycle) + ">1</option></select>" +
            "<br>allow_marketplace_sell: <select name='allow_marketplace_sell'><option value='0'>0</option><option value='1' " + checkselected(baseitem.allow_marketplace_sell) + ">1</option></select>" +
            "<br>allow_inventory_stack: <select name='allow_inventory_stack'><option value='0'>0</option><option value='1' " + checkselected(baseitem.allow_inventory_stack) + ">1</option></select>" +
            "<br>interaction_type: <input name='interaction_type' value='" + baseitem.interaction_type + "'>" +
            "<br>interaction_modes_count: <input name='interaction_modes_count' value='" + baseitem.interaction_modes_count + "'>" +
            "<br>vending_ids: <input name='vending_ids' value='" + baseitem.vending_ids + "'>" +
            "<br>multiheight: <input name='multiheight' value='" + baseitem.multiheight + "'>" +
            "<br>customparams: <input name='customparams' value='" + baseitem.customparams + "'>" +
            "<br>effect_id_male: <input  type='number' name='effect_id_male' value='" + baseitem.effect_id_male + "'>" +
            "<br>effect_id_female: <input  type='number' name='effect_id_female' value='" + baseitem.effect_id_female + "'>" +
            "<br>clothing_on_walk: <input type='number' name='clothing_on_walk' value='" + baseitem.clothing_on_walk + "'>" +
